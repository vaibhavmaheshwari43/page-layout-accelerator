...
# ProcDNA branding -- logo only, no wordmark text (per request). Real logo
# embedded directly as base64. Note: CSS braces below are DOUBLED ({{ }})
# since this whole block is an f-string in app.py itself -- confirmed this
